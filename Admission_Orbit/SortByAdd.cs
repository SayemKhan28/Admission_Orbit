...
{
    public partial class SortByAdd : Form
    {
        DataTable uniTable;
        ...
        private void LoadUniversityData()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cs))
                {
                    ...
                    string query = "SELECT [University Name], [Application Starting Date] FROM dbo.Public_Uni";
                    ...
                    dv.Sort = "[Application Starting Date] ASC";
        ...
        private void MakeUniversityColumnClickable()
        {
            ...
            dateCol.HeaderText = "Admission Date";
            dateCol.DataPropertyName = "Application Starting Date";
        ...
        private void SortByAdd_Load(object sender, EventArgs e)
        {
